...
public class HomeFragment extends Fragment {
    private static final String[] TimeNames = {"morning", "afternoon", "evening"};
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        int[] customBtnIds = {R.id.customWkTestMax, R.id.customWkEndurance, R.id.customWkStrength,
                R.id.customWkSE, R.id.customWkHIC};
        for (int i = 0; i < 5; ++i) {
    ...
    private void updateGreeting() {
        greetingLabel.setText(ViewHelper.format("Good %s!", TimeNames[viewModel.timeOfDay]));
    }
    ...
    private final View.OnClickListener dayWorkoutListener = new View.OnClickListener() {
        @Override
        public void onClick(View view) { delegate.addWorkoutFromPlan(ViewHelper.getTag(view)); }
    };
